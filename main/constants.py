...
LIST_WEIGHTS = (WEIGHT_VERY_LIGHT, WEIGHT_LIGHT, WEIGHT_MEDIUM, WEIGHT_HEAVY, WEIGHT_VERY_HEAVY)
CHOICES_WEIGHTS = (
    (WEIGHT_VERY_LIGHT, WEIGHT_VERY_LIGHT),
    (WEIGHT_LIGHT, WEIGHT_LIGHT),
    (WEIGHT_MEDIUM, WEIGHT_MEDIUM),
    (WEIGHT_HEAVY, WEIGHT_HEAVY),
    (WEIGHT_VERY_HEAVY, WEIGHT_VERY_HEAVY),
)


# formatting in templatetags
FORMAT_PRICE_HUNDREDS = 100
FORMAT_PRICE_THOUSANDS = 1_000

CATEGORY_BOARD_GAME = 'Board Game'
CATEGORY_EXPANSION = 'Expansion'
CATEGORY_DND = 'Dungeons & Dragons'
CATEGORY_XWING = 'X-Wing'
CATEGORY_SHATTERPOINT = 'Shatterpoint'
CATEGORY_LEGION = 'Star Wars Legion'
CATEGORY_ARKHAM_HORROR = 'Arkham Horror'
CATEGORY_GAME_OF_THRONES = 'Game of Thrones'
CATEGORY_LORD_OF_THE_RINGS = 'Lord of the Rings'
CATEGORY_TOYS = 'Toys'
CATEGORY_ACCESSORIES = 'Accessories'
CATEGORY_MARVEL_CHAMPS = 'Marvel Champions'
CATEGORY_CRISIS_PROTOCOL = 'Marvel Crisis Protocol'
CATEGORY_CHOICES = [
    [CATEGORY_BOARD_GAME, CATEGORY_BOARD_GAME],
    [CATEGORY_EXPANSION, CATEGORY_EXPANSION],
    [CATEGORY_DND, CATEGORY_DND],
    [CATEGORY_XWING, CATEGORY_XWING],
    [CATEGORY_SHATTERPOINT, CATEGORY_SHATTERPOINT],
    [CATEGORY_LEGION, CATEGORY_LEGION],
    [CATEGORY_ARKHAM_HORROR, CATEGORY_ARKHAM_HORROR],
    [CATEGORY_GAME_OF_THRONES, CATEGORY_GAME_OF_THRONES],
    [CATEGORY_LORD_OF_THE_RINGS, CATEGORY_LORD_OF_THE_RINGS],
    [CATEGORY_TOYS, CATEGORY_TOYS],
    [CATEGORY_ACCESSORIES, CATEGORY_ACCESSORIES],
    [CATEGORY_MARVEL_CHAMPS, CATEGORY_MARVEL_CHAMPS],
    [CATEGORY_CRISIS_PROTOCOL, CATEGORY_CRISIS_PROTOCOL],
]
