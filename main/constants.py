...
PROVINCES_LIST = [
    PROVINCE_WESTERN_CAPE, PROVINCE_NORTHERN_CAPE, PROVINCE_EASTERN_CAPE,
    PROVINCE_GAUTENG, PROVINCE_MPUMALANGA, PROVINCE_LIMPOPO,
    PROVINCE_NORTH_WEST, PROVINCE_FREE_STATE, PROVINCE_KWAZULU_NATAL,
]
